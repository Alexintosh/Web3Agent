              ...
              <Tab.Panels className="mt-2">
                ...
                >
                  <div className="h-[calc(100vh-260px)] flex flex-col justify-center items-center gap-4 ">
                    ...
                    <div className='text-2xl font-medium text-gray-600'>Hi! I am DEFI Propmt {JSON.stringify(operations)}</div><div className='text-lg font-medium text-gray-600'>"Simply tell me what you need, and I'll make it happen."</div>
                  </div>
                </Tab.Panel>
